...
export const STAGE_DEFINITIONS = [
  {
    ...
    contentNote: "下方展示当前项目已持久化的正式创意内容。",
  },
  {
    key: "storyboard",
    label: "分镜规划",
    ...
    contentNote: "下方展示当前项目已持久化的正式分镜内容。",
  },
  {
    key: "video-prompt",
    label: "视频提示词",
    ...
    contentNote: "下方展示当前项目已持久化的正式视频提示词。",
  },
  {
    key: "shots",
    label: "镜头",
  ...
  },
  {
    ...
    contentNote: "下方展示当前正式合片、版本状态与已有视频。",
  },
  {
    key: "voice",
    label: "配音",
    ...
    contentNote: "下方展示正式配音、脚本、Timeline 校准与已有音频。",
  },
  {
    key: "subtitle",
    label: "字幕",
    ...
    contentNote: "下方展示正式字幕来源与已保存的实际 Cue 内容。",
  },
  {
    key: "music",
    label: "音乐",
    ...
    contentNote: "下方展示正式音乐、已有音频与 Music Mix 配置。",
  },
  {
    key: "export",
    label: "最终导出",
    ...
    contentNote: "下方展示最终导出、关联组件版本与已有成片。",
  },
] as const;
