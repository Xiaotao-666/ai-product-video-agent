    ...
    def test_10_no_unimplemented_action_endpoint_is_published(self):
        ...
        self.assertEqual(
            set(schema["paths"]),
            {
                ...
                "/api/projects/{project_id}/planning/creative/approve",
                ...
                "/api/projects/{project_id}/planning/video-prompts/revise",
                ...
                "/api/projects/{project_id}/references/{asset_id}/image",
                "/api/projects/{project_id}/shots/{shot_id}/generation/options",
                "/api/projects/{project_id}/shots/{shot_id}/generation/preflight",
                "/api/projects/{project_id}/shots/{shot_id}/generation/failed-retry/options",
                "/api/projects/{project_id}/shots/{shot_id}/generation/failed-retry/preflight",
                "/api/projects/{project_id}/shots/{shot_id}/generation/failed-retry",
                ...
                "/api/projects/{project_id}/assembly/readiness",
                "/api/projects/{project_id}/assembly/plan",
                ...
                "/api/projects/{project_id}/post-production/voice/options",
                "/api/projects/{project_id}/post-production/voice/preflight",
                "/api/projects/{project_id}/post-production/voice/generate",
                "/api/projects/{project_id}/post-production/voice/regenerate",
                "/api/projects/{project_id}/post-production/voice/history",
                "/api/projects/{project_id}/post-production/voice/versions/{version}",
                "/api/projects/{project_id}/post-production/voice/versions/{version}/audio",
                "/api/projects/{project_id}/post-production/voice/timing-acceptance",
                "/api/projects/{project_id}/post-production/subtitle",
                "/api/projects/{project_id}/post-production/subtitle/options",
                "/api/projects/{project_id}/post-production/subtitle/generate",
                "/api/projects/{project_id}/post-production/subtitle/regenerate",
                "/api/projects/{project_id}/post-production/subtitle/history",
                "/api/projects/{project_id}/post-production/subtitle/versions/{version}",
                "/api/projects/{project_id}/post-production/music",
                "/api/projects/{project_id}/post-production/music/audio",
                "/api/projects/{project_id}/post-production/music/options",
                "/api/projects/{project_id}/post-production/music/upload",
                "/api/projects/{project_id}/post-production/music/mix",
                "/api/projects/{project_id}/post-production/music/mix/reset",
                "/api/projects/{project_id}/post-production/music/history",
                "/api/projects/{project_id}/post-production/music/versions/{version}",
                "/api/projects/{project_id}/post-production/music/versions/{version}/audio",
                "/api/projects/{project_id}/export",
                "/api/projects/{project_id}/export/video",
                "/api/projects/{project_id}/export/preflight",
                "/api/projects/{project_id}/export/execute",
                "/api/projects/{project_id}/export/history",
                "/api/projects/{project_id}/export/versions/{version}",
                "/api/projects/{project_id}/export/versions/{version}/video",
                "/api/tasks/{task_id}",
